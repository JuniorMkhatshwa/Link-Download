package com.example.link_download;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnSave, btnLoad,getBtn;
    EditText etInput;
    TextView tvLoad,result;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Document document = Jsoup.connect("https://www.news24.com/").timeout(6000).get();
                    ...
                    // storeVisitedLinks(links.attr("abs:href"));
    ...
    private void onClick(View view) {
        ...
        if (isStoragePermissionGranted()) {
            ...
            if (!fileContent.equals("")) {
                ...
                Toast.makeText(MainActivity.this, "Information saved to database.", Toast.LENGTH_SHORT).show();
            } else {
